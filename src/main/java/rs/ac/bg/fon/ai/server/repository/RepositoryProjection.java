...
//
//    @Override
//    public void add(Projection p) throws Exception {
//        try {
...
//            statement.setLong(1, p.getFilm().getId());
//            statement.setLong(2, p.getHall().getId());
//            statement.setDate(3, java.sql.Date.valueOf(p.getDate()));
//            statement.setTime(4, java.sql.Time.valueOf(p.getTime()));
//            statement.setString(5, p.getStatus().toString());
//            statement.setBigDecimal(6, p.getPrice());
//            statement.setInt(7, p.getSoldTickets());
//
...
//                System.out.println("dohvacen kljuc za projekciju");
//            }
//
//            rs.close();
//            statement.close();
...
//
//    @Override
//    public void edit(Projection projection) throws Exception {
//        String sql = "UPDATE projection SET film_id = ?, hall_id = ?, date = ?, time = ?, price = ? WHERE id = ?";
//        PreparedStatement statement = DbConnectionFactory.getInstance().getConnection().prepareStatement(sql);
//        statement.setLong(1, projection.getFilm().getId()); // film_id
//        statement.setLong(2, projection.getHall().getId()); // hall_id
//        statement.setDate(3, java.sql.Date.valueOf(projection.getDate())); // date
//        statement.setTime(4, java.sql.Time.valueOf(projection.getTime())); // time
//        statement.setBigDecimal(5, projection.getPrice()); // price
//        statement.setLong(6, projection.getId()); // id - WHERE clause
//
//        int affectedRows = statement.executeUpdate();
//
//        if (affectedRows == 0) {
//            throw new Exception("Projekcija nije pronađena u bazi!");
//        }
//
//    }
//
//    @Override
//    public void delete(Projection projection) throws Exception {
...
//
//    @Override
//    public Projection getById(Long id) throws Exception {
//        Projection p = null;
//
//        try {
//            String sql = "SELECT pr.id AS prid, pr.date AS pdate, pr.time AS ptime, pr.status AS pstatus, "
...
//            rs.close();
//            ps.close();
//            System.out.println("Uspesno ucitana projekcija ID = " + id);
//        } catch (SQLException ex) {
//            System.out.println("Neuspesno ucitavanje projekcije ID = " + id);
//            throw ex;
//        }
//
//        return p;
...
//
//    @Override
//    public void update(Projection p) throws SQLException {
//        String sql = "UPDATE Projection SET sold_tickets = ?, status = ? WHERE id = ?";
//        PreparedStatement ps = DbConnectionFactory.getInstance().getConnection().prepareStatement(sql);
//        ps.setInt(1, p.getSoldTickets());
//        ps.setString(2, p.getStatus().toString());
