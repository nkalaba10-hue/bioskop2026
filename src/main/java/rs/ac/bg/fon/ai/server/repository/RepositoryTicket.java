...
//            rs.close();
//            ps.close();
//            System.out.println("Ucitana lista tiketa");
...
//
//                // DOHVAT GENERISANOG ID-A I POSTAVLJANJE NA OBJEKAT
//                ResultSet rs = statement.getGeneratedKeys();
//                if (rs.next()) {
//                    Long generatedId = rs.getLong(1);
//                    t.setId(generatedId);  // ← Postavi ID na ticket
//                    System.out.println("Generisan ID za ticket: " + generatedId);
//                }
//
//                rs.close();
//                statement.close();
//                System.out.println("Uspesno kreiranje Ticket-a sa ID: " + t.getId());
//            }
//
