...
/**
 * Sistemska operacija za cuvanje racuna, njegovih tiketa i azuriranje
 * broja prodatih karata za projekcije.
 *
 * @author nkala
 * @version 1.0
 */
public class SaveBillSO extends AbstractSO {
    ...
    /**
     * Povecava broj prodatih karata za sve projekcije sa tiketa racuna.
     * Po potrebi postavlja status projekcije na {@code SOLD_OUT}.
     *
     * @param bill novokreirani racun sa tiketima
    ...
    /**
     * Pronalazi projekciju po njenom identifikatoru.
     *
     * @param projectionId identifikator trazene projekcije
